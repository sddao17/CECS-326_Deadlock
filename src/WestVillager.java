 ...
 * Purpose: This class defines the west village thread.
 */
public class WestVillager implements Runnable {
    ...
    /**
     * Constructs a new WestVillage instance using the provided semaphore.
     *
     * @param newRoad the new instance of the semaphore to keep count
     */
    public WestVillager(Semaphore newRoad) {
        villageRoad = newRoad;
        hasUsedRoad = false;
    }

    /**
     * Runs the thread representing the west village by simulating an activity.
     */
    @Override
    public void run() {
